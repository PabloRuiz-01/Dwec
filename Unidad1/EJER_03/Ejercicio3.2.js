//Implementa suma, resta y potencia como funciones flecha, y 
//aplicarOperacion, una función de orden superior que reciba dos números y la operación a aplicar.
...
const potencia = (base, exponente) => {
  if (exponente<0) {
    throw new Error("El exponente no puede ser menor a cero");
  }
